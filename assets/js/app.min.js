...
(function ($) {
  var wind_ = $(window),
    ...
    navigation_level_icon: 'fa fa-plus'
  ...
  wind_.on('load', function () {
    setTimeout(function () {
      ...
      $('.navigation .navigation-menu-body ul li.open>a>.sub-menu-arrow').removeClass('fa-plus').addClass('fa-minus').addClass('rotate-in');
      $('body.horizontal-navigation .horizontal-navigation ul li a').each(function () {
        var $this = $(this);

        if ($this.next('ul').length) {
          $this.append('<i class="sub-menu-arrow fa fa-chevron-right"></i>');
        }
      });
    }, 200);
  ...
  $(document).on('click', '.navigation ul li a', function () {
    ...
    if ($this.next('ul').length) {
      if (!body_.hasClass('horizontal-navigation') || wind_.width() < 1200) {
        ...
        $this.next('ul').find('li>a').find('.sub-menu-arrow').removeClass('fa-minus').addClass('fa-plus');
        $this.next('ul').find('li>a').find('.sub-menu-arrow').removeClass('rotate-in');
        $this.parent('li').siblings().not($this.parent('li').find('ul')).find('>a').find('.sub-menu-arrow').removeClass('fa-minus').addClass('fa-plus');
        ...
        if (sub_menu_arrow.hasClass('rotate-in')) {
          setTimeout(function () {
            sub_menu_arrow.removeClass('fa-plus').addClass('fa-minus');
          }, 200);
        } else {
          sub_menu_arrow.removeClass('fa-minus').addClass('fa-plus');
        }
  ...
  $(document).on('mouseleave', 'body.small-navigation .navigation', function (e) {
    ...
    $(this).find('.navigation-menu-body ul').prev('a').find('.sub-menu-arrow').removeClass('rotate-in fa-minus').addClass('fa-plus');
  });
