function SWAL(title = 'ThĂ´ng bĂ¡o', text = 'ThĂ nh cĂ´ng!', type = 'success', back = false, redirect = null) {
    if (back) {
        Swal.fire({
            title: title,
            text: text,
...
function initDatatable($element, $ajax = null, $columns = null, $rowConfig = null) {
    ...
    var $configObj = {
        ...
        "lengthMenu": [
            ...
            [5, 10, 20, 30, 40, 50, 100, 200, 500, 1000, "Táº¥t cáº£"]
        ],
        "columnDefs": [{
            "searchable": false,
            "orderable": false,
        ...
        "info": true,
        "language": {
            "lengthMenu": "Hiá»ƒn thá»‹ _MENU_ káº¿t quáº£ trĂªn trang",
            "zeroRecords": "KhĂ´ng tĂ¬m tháº¥y káº¿t quáº£ nĂ o",
            "info": "Hiá»ƒn thá»‹ _START_ Ä‘áº¿n _END_ trong tá»•ng sá»‘ _MAX_ káº¿t quáº£",
            "infoEmpty": "KhĂ´ng tĂ¬m tháº¥y káº¿t quáº£ nĂ o phĂ¹ há»£p",
            "infoFiltered": "(lá»c tá»« _MAX_ tá»•ng sá»‘ báº£n ghi)",
            "infoPostFix": "",
            "thousands": ",",
            ...
            "search": "TĂ¬m kiáº¿m:",
            "zeroRecords": "KhĂ´ng tĂ¬m tháº¥y káº¿t quáº£ nĂ o phĂ¹ há»£p",
            "searchPlaceholder": "Nháº­p ná»™i dung...",
            "paginate": {
                "first": "Trang Ä‘áº§u",
                "last": "Trang cuá»‘i",
                "next": "Tiáº¿p",
            ...
            "aria": {
                "sortAscending": ": kĂ­ch hoáº¡t sáº¯p xáº¿p tÄƒng dáº§n",
                "sortDescending": ": kĂ­ch hoáº¡t sáº¯p xáº¿p giáº£m dáº§n"
            }
        }
    };
    if ($ajax) {
...
function countUpPrice(price) {
    ...
    $order_amount.append(`<span id="price">${formatNumber(price)}</span> <span class="price-unit">VNÄ</span>`);
